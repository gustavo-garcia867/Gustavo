---
title: "Project Company will fail in 2 years - Gustavo"
...
df <- read.csv('G:/Meu Drive/Data Fee/Insper/Projeto Integrador 1 tri/df.csv')
df
...
legend(x = .05, y = .8, legend=c("Logística", "Ridge", "Lasso", "Elastic Net", "Árvore"), col=c("#1c61b6", "#b61c4a", "#2a9d8f", "#d35400", "#8e44ad"), lwd=2,
